...
function VideoPlayer({ title, selectedCourse }) {
  ...
  return (
    <div className="video-player" style={{ background: 'transparent' }}>
      ...
      <div className="player-container" style={{ background: 'transparent' }}>
        {selectedCourse && (
          <video
            ref={videoRef}
      ...
      <div className="video-description" style={{ background: 'rgba(0, 0, 0, 0.3)', backdropFilter: 'blur(5px)' }}>
