...
function Home() {
  ...
  useEffect(() => {
    ...
    const animation = lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: 'https://assets9.lottiefiles.com/packages/lf20_tA4qVpnCpk.json' // Lottie动画的URL
    });
  ...
  return (
    <div className="home">
      <div id="lottie-container" style={{ width: '100%', height: '100vh', position: 'absolute', top: 0, left: 0, zIndex: -1 }}></div>
