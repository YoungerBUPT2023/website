...
function Home() {
  ...
  const aiCards = [
    {
      ...
      image: "/images/space-simulator.jpg",
      path: "/lab",
    },
    {
      title: "多维度实验评估",
      description: "我们的AI智能体将从多个维度全面准确地评估实验方案并给出分析报告",
      image: "/images/rocket-simulator.jpg",
      path: "/lab",
    },
    {
      title: "实验报告代码生成",
      description: "我们的AI将根据实验报告生成完整准确的代码，并有三种语言可选",
      image: "/images/galaxy-formation.jpg",
      path: "/space-view",
    }
  ];
  ...
  const features = [
    ...
    { 
      ...
      desc: "分享交流实验经验与创新想法", 
      longDesc: [
        "在这里，来自全国各地的学生和研究者可以互相交流实验经验和创新想法，共同探讨太空科学领域的前沿问题。",
        "【社区特色】",
        "• 实验分享区：分享您的实验设计和成果",
        "• 专题讨论：围绕特定科学主题的深入讨论",
        "• 实时问答：与专家和同行进行实时交流"
    ...
    <div className="home">
      ...
      >
        <motion.h2 
          ...
          style={{
            ...
            textAlign: 'center',
            marginBottom: '3rem',
            background: 'linear-gradient(90deg, #64d9ff, #b57aff)',
            WebkitBackgroundClip: 'text',
            backgroundClip: 'text',
            color: 'transparent',
            fontWeight: '700',
          ...
          {aiCards.map((card, index) => (
            <motion.div
              ...
              whileHover={{
                ...
                boxShadow: '0 15px 40px rgba(100, 217, 255, 0.2)'
              }}
            >
              <div style={{
                width: '100%',
                ...
                <div 
                  style={{
                    ...
                    width: '100%',
                    height: '100%',
                    background: 'linear-gradient(rgba(0,0,0,0), rgba(10, 17, 36, 0.8))',
                    zIndex: 1
                  }}
                />
                <img 
              ...
              <div style={{ 
                ...
                <Link 
                  ...
                  onMouseOver={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 6px 25px rgba(124, 77, 255, 0.5)';
                  }}
                  onMouseOut={(e) => {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.boxShadow = '0 4px 20px rgba(124, 77, 255, 0.3)';
                  }}
                >
                  了解更多
                </Link>
      ...
      >
        ...
        <div className="view-all-link">
          <a href="/gallery" className="view-all-btn">进入社区</a>
        </div>
      </section>
