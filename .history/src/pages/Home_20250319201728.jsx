    ...
    <div className="home">
      ...
      >
        <motion.p
          ...
          style={{
            ...
            color: '#a881e6',
            textShadow: '0 0 15px rgba(168, 129, 230, 0.4)',
          }}
        >
          AI驱动太空科学实验平台
        </motion.p>
        <motion.h1 
          ...
          style={{ 
            ...
            color: '#8e24aa',
            textShadow: '0 0 30px rgba(142, 36, 170, 0.4), 0 0 60px rgba(142, 36, 170, 0.2)',
          }}
        >
          问天
        </motion.h1>
        ...
        >
          <motion.p
            style={{ 
              ...
              color: '#ce93d8',
              textShadow: '0 0 15px rgba(142, 36, 170, 0.3)',
            }}
          >
            探索AI驱动科学与太空新时代
          </motion.p>
      ...
      <motion.div
        ...
        style={{
          ...
          height: '50vh',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(142, 36, 170, 0.2) 0%, rgba(103, 58, 183, 0.05) 50%, rgba(0, 0, 0, 0) 70%)',
          filter: 'blur(60px)',
          zIndex: 0,
          pointerEvents: 'none',
      ...
      <motion.div
        ...
        style={{
          ...
          height: '40vh',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(186, 104, 200, 0.15) 0%, rgba(142, 36, 170, 0.05) 50%, rgba(0, 0, 0, 0) 70%)',
          filter: 'blur(50px)',
          zIndex: 0,
          pointerEvents: 'none',
      ...
      <motion.div
        ...
        style={{
          ...
          height: '45vh',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(209, 196, 233, 0.15) 0%, rgba(103, 58, 183, 0.05) 50%, rgba(0, 0, 0, 0) 70%)',
          filter: 'blur(55px)',
          zIndex: 0,
          pointerEvents: 'none',
