    ...
    <div className="home">
      ...
      <div className="footer" style={{ 
        ...
        <div style={{ 
          ...
          {/* 第一栏：logo和团队介绍 */}
          <div style={{ flex: '1 1 300px', marginBottom: '30px', textAlign: 'center' }}>
            ...
            <h3 style={{ color: '#fff', marginBottom: '10px', fontSize: '1.3rem', fontWeight: '500' }}>星启智空团队 | StellarMindscapes</h3>
            <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.9rem', lineHeight: '1.6', maxWidth: '280px', margin: '0 auto' }}>
              创新AI与太空科学教育平台，探索未知，启迪未来
            </p>
          </div>
          
          {/* 第二栏：快速链接 */}
          <div style={{ flex: '1 1 200px', marginBottom: '30px', textAlign: 'center' }}>
            <h4 style={{ color: '#fff', fontSize: '1.1rem', marginBottom: '20px', position: 'relative' }}>
              <span style={{ position: 'relative', zIndex: 1 }}>快速链接</span>
              <span style={{ position: 'absolute', bottom: '-6px', left: '50%', transform: 'translateX(-50%)', width: '40px', height: '2px', background: 'rgba(100, 217, 255, 0.6)' }}></span>
            </h4>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
              <li style={{ margin: '10px 0' }}>
                <a href="/lab" style={{ color: 'rgba(255, 255, 255, 0.8)', textDecoration: 'none', fontSize: '0.95rem', transition: 'color 0.3s' }}>实验室</a>
              </li>
              <li style={{ margin: '10px 0' }}>
                <a href="/gallery" style={{ color: 'rgba(255, 255, 255, 0.8)', textDecoration: 'none', fontSize: '0.95rem', transition: 'color 0.3s' }}>作品展示</a>
              </li>
              <li style={{ margin: '10px 0' }}>
                <a href="/about" style={{ color: 'rgba(255, 255, 255, 0.8)', textDecoration: 'none', fontSize: '0.95rem', transition: 'color 0.3s' }}>关于我们</a>
              </li>
            </ul>
          </div>
          ...
          <div style={{ flex: '1 1 200px', marginBottom: '30px', textAlign: 'center' }}>
            <h4 style={{ color: '#fff', fontSize: '1.1rem', marginBottom: '20px', position: 'relative' }}>
              <span style={{ position: 'relative', zIndex: 1 }}>关注我们</span>
              <span style={{ position: 'absolute', bottom: '-6px', left: '50%', transform: 'translateX(-50%)', width: '40px', height: '2px', background: 'rgba(100, 217, 255, 0.6)' }}></span>
            </h4>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '15px' }}>
              {/* GitHub图标 */}
              <a href="https://github.com/YoungerBUPT2023/website-children" target="_blank" rel="noopener noreferrer" 
                style={{ color: 'rgba(255, 255, 255, 0.8)', padding: '8px', borderRadius: '50%', background: 'rgba(100, 217, 255, 0.1)' }}>
              ...
              <a href="#" 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <path d="M12 8c-2-.2-5 .5-5 4 0 5 6 7 7 2"></path>
                </svg>
              </a>
            </div>
          </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <a href="/privacy" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px' }}>隐私政策</a>
            <a href="/terms" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px' }}>服务协议</a>
          </div>
        </div>
      </div>
