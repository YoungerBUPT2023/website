          ...
          >
            <Canvas camera={{ position: [0, 0, 5], fov: 45 }}>
              ...
              <Suspense fallback={null}>
                {index === 0 ? (
                  <LabEquipment color={color} scale={1.2} />
                ) : index === 1 ? (
                  <group>
                    <Nebula color={color} position={[0, 0, -2]} scale={0.3} />
                    <Rocket color={color} position={[-3, 0, 0]} direction={[1, 0.2, 0]} />
                  </group>
                ) : index === 2 ? (
                  <group>
                    <Nebula color={color} position={[0, 0, -3]} scale={0.2} />
                    <mesh position={[0, 0, 0]}>
                  ...
                  <group>
                    <Satellite color={color} position={[0, 0, 0]} scale={1.2} />
                    <Stars radius={10} depth={5} count={500} factor={2} saturation={0} fade />
                  </group>
                )}
              </Suspense>
              <OrbitControls 
