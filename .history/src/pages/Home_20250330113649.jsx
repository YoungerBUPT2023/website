      ...
      <div className="footer" style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ marginTop: '15px' }}>
            <Link to="/privacy-policy" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px', fontSize: '0.85rem' }}>隐私政策</Link>
            <Link to="/service-agreement" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px', fontSize: '0.85rem' }}>服务协议</Link>
          </div>
        </div>
      </div>
