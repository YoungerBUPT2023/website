...
const PrivacyPolicyContent = () => (
  <div>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>1. 引言</h4>
    <p>欢迎使用我们的 AI 驱动太空科学网站（"本网站"）。本隐私政策解释了我们如何收集、使用、存储和保护您的个人信息。使用本网站，即表示您同意本隐私政策的条款。</p>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>2. 我们收集的信息</h4>
    <p>我们可能收集以下信息：</p>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>3. 我们如何使用信息</h4>
    <p>我们收集的信息将用于：</p>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
      <li>提供和优化 AI 分析服务。</li>
      <li>维护和改进网站功能。</li>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>4. 信息共享与披露</h4>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>5. 数据安全</h4>
    <p>我们采取合理的安全措施来保护您的数据，包括加密、访问控制和安全存储。然而，互联网数据传输无法保证绝对安全，请妥善保管您的账号信息。</p>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>6. 用户权利</h4>
    <p>您可以：</p>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>7. Cookie 与追踪技术</h4>
    <p>我们使用 Cookie 以提升用户体验，您可以在浏览器设置中管理 Cookie 偏好。</p>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>8. 政策变更</h4>
    <p>我们可能更新本政策，变更后会通过网站公告或电子邮件通知用户。</p>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>9. 联系方式</h4>
    <p>如有任何隐私问题，请联系我们：contact@stellarmindscapes.com</p>
  </div>
);
...
const ServiceAgreementContent = () => (
  <div>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>2. 账户注册与使用</h4>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>3. 服务使用规则</h4>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
    ...
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>4. 知识产权</h4>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
      <li>用户上传的作品归用户所有，但用户授予本网站有限的许可，以便执行 AI 分析等服务。</li>
      <li>AI 生成的分析数据归网站所有，但用户可自由使用自己的分析结果。</li>
    </ul>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>5. 责任限制</h4>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
      <li>本网站不对 AI 结果的准确性或适用性作出保证。</li>
      <li>用户需自行判断分析结果的适用性，网站不承担因使用结果造成的损失。</li>
    </ul>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>6. 账户终止</h4>
    <ul style={{ margin: '10px 0', paddingLeft: '20px' }}>
      <li>用户可随时注销账户。</li>
      <li>如用户违反本协议，我们可暂停或终止服务。</li>
    </ul>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>7. 争议解决</h4>
    <p>本协议适用中华人民共和国法律。争议应通过友好协商解决，协商不成的，提交北京市有管辖权的人民法院解决。</p>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>8. 变更与修订</h4>
    <p>我们可随时更新本协议，用户在变更后继续使用即视为接受新条款。</p>
    
    <h4 style={{ color: '#fff', marginTop: '15px', marginBottom: '8px' }}>9. 联系方式</h4>
    <p>如有疑问，请联系我们：contact@stellarmindscapes.com</p>
  </div>
);
        ...
        <div style={{ 
          ...
          <div style={{ flex: '1 1 300px', marginBottom: '30px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '5px' }}>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '0.95rem', margin: '0' }}>徐文阳</p>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '0.95rem', margin: '0' }}>唐资仪</p>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '0.95rem', margin: '0' }}>李星昱</p>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '0.95rem', margin: '0' }}>李如璟</p>
            </div>
          </div>
