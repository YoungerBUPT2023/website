    ...
    <div className="home">
      ...
      >
        <motion.p
          ...
          style={{
            ...
            background: 'linear-gradient(90deg, #64b5f6 0%, #e57373 50%, #81c784 100%)',
        ...
        <motion.h1 
          ...
          style={{ 
            ...
            background: 'linear-gradient(135deg, #64b5f6 0%, #e57373 40%, #ffb74d 70%, #81c784 100%)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
        ...
        >
          <motion.p
            style={{ 
              ...
              background: 'linear-gradient(90deg, #64b5f6 0%, #ffb74d 50%, #e57373 100%)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
      ...
      <motion.div
        ...
        style={{
          ...
          height: '50vh',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(64, 156, 255, 0.2) 0%, rgba(0, 87, 183, 0.05) 50%, rgba(0, 0, 0, 0) 70%)',
          filter: 'blur(60px)',
          zIndex: 0,
          pointerEvents: 'none',
      ...
      <motion.div
        ...
        style={{
          ...
          height: '40vh',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(255, 100, 130, 0.15) 0%, rgba(183, 0, 106, 0.05) 50%, rgba(0, 0, 0, 0) 70%)',
          filter: 'blur(50px)',
          zIndex: 0,
          pointerEvents: 'none',
      ...
      <motion.div
        ...
        style={{
          ...
          height: '45vh',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(120, 255, 200, 0.15) 0%, rgba(0, 183, 102, 0.05) 50%, rgba(0, 0, 0, 0) 70%)',
          filter: 'blur(55px)',
          zIndex: 0,
          pointerEvents: 'none',
