...
const Gallery = () => {
  ...
  // 添加视图模式状态
  const [viewMode, setViewMode] = useState('gallery'); // 'gallery' 或 'experiments'
  ...
  return (
    <div className="gallery-container">
      ...
      <div className="gallery-page">
        ...
        {/* 修改内部导航栏，让"作品展"和"实验示例"成为平行选项 */}
        <div className="gallery-nav">
          <button 
            className={viewMode === 'gallery' ? 'nav-active' : ''}
            onClick={() => setViewMode('gallery')}
          >
            作品展
          </button>
          <button 
            className={viewMode === 'experiments' ? 'nav-active' : ''}
          ...
          <div className="experiments-container">
            ...
            <div className="experiments-grid">
              ...
              <div className="experiment-card">
                ...
                <div className="experiment-content">
                  <h3 className="experiment-title">星系形成模拟</h3>
                  <p>观察不同初始条件下星系的形成和演化过程</p>
                  <div className="experiment-meta">
                    <span className="experiment-date">2023年8月</span>
                    <span className="experiment-author">王力</span>
                  </div>
              ...
              <div className="experiment-card">
                <div className="experiment-thumbnail" style={{
                  backgroundImage: "url('/images/astronaut-training.jpg')"
                }}></div>
                <div className="experiment-content">
                  <h3 className="experiment-title">宇航员训练模拟</h3>
                  <p>模拟宇航员的太空行走和操作任务，体验太空环境的挑战</p>
                  <div className="experiment-meta">
                    <span className="experiment-date">2023年7月</span>
                    <span className="experiment-author">张伟</span>
                  </div>
