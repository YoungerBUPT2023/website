  ...
  return (
    <div className="gallery-container">
      <div className="gallery-page">
        ...
        {viewMode === 'sciencePop' && (
          <div className="science-popularization-container" style={{ padding: '40px 20px', color: 'white' }}>
            <h2 style={{ textAlign: 'center', marginBottom: '30px', fontSize: '2rem', color: '#e0f2fe' }}>
              太空科普知识
            </h2>
            <div style={{ maxWidth: '800px', margin: '0 auto', background: 'rgba(255, 255, 255, 0.05)', padding: '30px', borderRadius: '10px' }}>
              <p style={{ lineHeight: 1.8, fontSize: '1.1rem' }}>
                这里将展示引人入胜的太空科普文章、视频和互动内容。
                敬请期待更多关于宇宙奥秘、航天技术和天文学发现的精彩内容！
              </p>
            </div>
          </div>
        )}
