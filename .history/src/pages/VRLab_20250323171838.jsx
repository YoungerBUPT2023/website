        ...
        <div className="video-player">
          ...
          <div className="player-container">
            <ReactPlayer
              ...
              url="https://www.bilibili.com/video/BV1uz4y1L7F8"
              playing={true}
              controls={true}
              width="100%"
              height="100%"
            ...
            <div className="player-controls">
              <div className="control-info">
                <span className="stream-status">⚪ 正在播放中...</span>
          ...
          <div className="player-container" style={{ marginTop: '20px' }}>
            <div style={{ width: '100%', height: '400px', position: 'relative' }}>
              <iframe 
                src="//player.bilibili.com/player.html?bvid=BV1uz4y1L7F8&page=1&high_quality=1&danmaku=0" 
                scrolling="no" 
                border="0" 
                frameBorder="no" 
                framespacing="0" 
