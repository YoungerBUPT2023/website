    ...
    <div className="home">
      ...
      <div className="footer" style={{ 
        ...
        <div style={{ 
          ...
          {/* 团队名称 */}
          <h3 style={{ color: '#fff', fontSize: '1.3rem', fontWeight: '500', marginBottom: '15px' }}>
          ...
          {/* 社交媒体 */}
          <div style={{ marginBottom: '25px' }}>
            <h4 style={{ color: '#fff', fontSize: '1.05rem', marginBottom: '15px' }}>关注我们</h4>
        ...
        <div style={{ 
          ...
          <p style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.9rem', margin: '0 0 15px 0' }}>
            © 2025 AI驱动太空科学实验平台
          </p>
