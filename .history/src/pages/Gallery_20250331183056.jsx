  ...
  return (
    <div className="gallery-container">
      <div className="gallery-page">
        ...
        {viewMode === 'challenge' && (
          <div className="challenge-container" style={{ padding: '40px 20px', color: 'white', textAlign: 'center' }}>
            <h2 style={{ marginBottom: '30px', fontSize: '2rem', color: '#e0f2fe' }}>
              太空实验挑战赛
            </h2>
            <div style={{ maxWidth: '800px', margin: '0 auto', background: 'rgba(255, 255, 255, 0.05)', padding: '40px', borderRadius: '10px' }}>
              <p style={{ lineHeight: 1.8, fontSize: '1.1rem' }}>
                欢迎参加我们的太空实验挑战赛！在这里，你可以提出创新的实验想法，参与设计挑战，赢取丰厚奖品。
              </p>
              <p style={{ lineHeight: 1.8, fontSize: '1.1rem', marginTop: '20px' }}>
                详细规则和报名信息即将公布，敬请期待！
              </p>
              {/* TODO: Add actual challenge information, rules, submission forms etc. */}
            </div>
          </div>
        )}
