...
import { OrbitControls, Stars, useTexture, useGLTF, Float, MeshDistortMaterial } from '@react-three/drei';
          ...
          >
            <Canvas camera={{ position: [0, 0, 5], fov: 45 }}>
              ...
              <Suspense fallback={null}>
                {index % 2 === 0 ? (
                  <Model3D 
                    path={index === 0 ? "/models/lab_equipment.glb" : 
                          index === 2 ? "/models/trophy.glb" : "/models/computer.glb"} 
                    scale={1.5} 
                    color={color} 
                  />
                ) : (
...
function Home() {
  ...
  const features = [
    { 
      ...
      path: "/lab", 
      color: "#4facfe",
      modelPath: "/models/lab_equipment.glb"
    },
    { 
      icon: "🥽", 
      title: "实验流程监控", 
      ...
      path: "/vr-lab", 
      color: "#00f2fe",
      modelPath: "/models/vr_headset.glb"
    },
    { 
      icon: "🏆", 
      title: "作品展", 
