        ...
        <div style={{ 
          ...
          <div style={{ marginTop: '15px' }}>
            <a href="#top" style={{ 
              ...
              <span style={{ marginBottom: '5px' }}>向下滚动</span>
          ...
          <div style={{ marginTop: '15px' }}>
            <a href="/privacy" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px', fontSize: '0.85rem' }}>隐私政策</a>
            <a href="/terms" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px', fontSize: '0.85rem' }}>服务协议</a>
          </div>
        </div>
      </div>
