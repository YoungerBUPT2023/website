...
function VRLab() {
  ...
  const [currentBvid, setCurrentBvid] = useState('BV1gD4y1S772');  // 当前播放的视频BV号
  ...
  const fetchUpVideos = () => {
    ...
    // 由于API限制，这里使用模拟数据
    const mockVideos = [
      { bvid: 'BV1gD4y1S772', title: '中国航天发射现场', cover: 'https://i0.hdslb.com/bfs/archive/xxx.jpg' },
      { bvid: 'BV1Ls4y1273d', title: '神舟十五号发射', cover: 'https://i0.hdslb.com/bfs/archive/yyy.jpg' },
      { bvid: 'BV1hG411R71m', title: '问天实验舱发射', cover: 'https://i0.hdslb.com/bfs/archive/zzz.jpg' },
      { bvid: 'BV1pv4y1e7oD', title: '航天员太空出舱', cover: 'https://i0.hdslb.com/bfs/archive/aaa.jpg' },
    ];
            ...
            <div className="player-container">
              ...
              <div className="player-controls">
                <div className="control-info">
                  ...
                  <span className="source-info">(天宫课堂视频 - UID:{bilibiliOfficialUID})</span>
                </div>
                {isAdmin && (
