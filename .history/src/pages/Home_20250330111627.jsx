...
function Home() {
  ...
  return (
    <div className="home">
      ...
      <div className="footer" style={{ padding: '80px 0 120px', textAlign: 'center', opacity: 0.8 }}>
        <div className="footer-logo">
          <img src="/images/tiangong_station.png" alt="星启智空团队" style={{ width: '100px', height: '100px', marginBottom: '15px', borderRadius: '50%', objectFit: 'cover', border: '2px solid rgba(100, 217, 255, 0.3)' }} />
        </div>
        <h3 style={{ color: '#fff', marginBottom: '12px', fontSize: '1.4rem', fontWeight: '500' }}>星启智空团队 | StellarMindscapes</h3>
        <p style={{ marginBottom: '15px', color: 'rgba(255, 255, 255, 0.8)' }}>© 2025 AI驱动太空科学实验平台</p>
        <a href="https://github.com/YoungerBUPT2023/website-children" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', color: '#42a5f5', textDecoration: 'none', fontSize: '1rem' }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '6px' }}>
