      ...
      >
        ...
        <motion.h1 
          ...
          style={{ 
            ...
            background: 'linear-gradient(135deg, #002171 0%, #2196f3 50%, #90caf9 100%)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
            textShadow: '0 0 30px rgba(33, 150, 243, 0.4)',
          }}
        >
          问天
        </motion.h1>
        ...
        >
          <motion.p
            style={{ 
              ...
              background: 'linear-gradient(90deg, #0288d1 0%, #64b5f6 100%)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              textShadow: '0 0 15px rgba(33, 150, 243, 0.25)',
            }}
          >
            探索AI驱动科学与太空新时代
          </motion.p>
