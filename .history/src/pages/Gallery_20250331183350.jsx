  ...
  return (
    <div className="gallery-container">
      <div className="gallery-page">
        ...
        {viewMode === 'challenge' && (
          <div className="challenge-container" style={{ padding: '40px 20px', color: 'white' }}>
            ...
            <div style={{ 
              ...
              <p style={{ lineHeight: 1.8, fontSize: '1.1rem', marginBottom: '25px' }}>
                欢迎加入"问天"平台首届太空实验挑战赛！我们邀请富有创造力和探索精神的你，设计能够在太空环境中进行的创新科学实验。这是一个将你的奇思妙想转化为潜在太空任务的绝佳机会。
              </p>
              ...
              <a 
                ...
                download 
                className="science-item-link" // 复用之前的按钮样式
                style={{ alignSelf: 'center' }} // 居中按钮
              >
                下载方案模板
              </a>
              ...
              <p style={{ lineHeight: 1.8, fontSize: '1.1rem', marginBottom: '10px' }}>
                各赛道将评选出一、二、三等奖及优秀奖若干名，颁发丰厚奖品及荣誉证书。优秀方案更有机会获得专家指导和进一步孵化的支持！
              </p>
