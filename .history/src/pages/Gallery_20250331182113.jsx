...
const Gallery = () => {
  ...
  // 添加视图模式状态
  const [viewMode, setViewMode] = useState('gallery'); // 'gallery', 'experiments', or 'sciencePop'
  ...
  const sciencePopContent = [
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1676747039111-a56d7f6f4a6e?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Placeholder JWST image
      linkUrl: 'https://science.nasa.gov/mission/webb/', // Example Link
    },
    {
      id: 'mars-life-1',
      type: 'article',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1614727101875-077c9d54a003?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Placeholder Mars Rover image
      linkUrl: 'https://science.nasa.gov/mission/perseverance/', // Example Link
    },
    {
      id: 'blackhole-1',
      type: 'video',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?q=80&w=1742&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Placeholder Black Hole image
      linkUrl: 'https://www.youtube.com/watch?v=e-P5IFTqB9c', // Example Youtube Link
    },
      {
      id: 'starship-1',
      type: 'article',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1639186458463-f3515a1a8a27?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Placeholder Starship image
      linkUrl: 'https://www.spacex.com/vehicles/starship/', // Example Link
    },
  ];
      ...
      <div className="gallery-page">
        ...
        {viewMode === 'sciencePop' && (
          <div className="science-popularization-container" > 
            ...
            <div className="science-pop-grid">
              {sciencePopContent.map(item => (
                <div key={item.id} className="science-item-card">
                  <div className="science-item-image-container">
                     <img src={item.imageUrl} alt={item.title} className="science-item-image" />
                     {item.type === 'video' && <div className="video-overlay"><span className="play-icon">▶</span></div>}
                  </div>
                  <div className="science-item-content">
