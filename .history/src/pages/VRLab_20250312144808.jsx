    ...
    <div className="video-player">
      ...
      <div className="player-container">
        {videoSource.type === 'test' ? (
          ...
          <iframe
            src={`//player.bilibili.com/player.html?aid=&bvid=&cid=&page=1&high_quality=1&danmaku=0&as_wide=1&autoplay=1&live_room_id=${videoSource.url}`}
            width="100%"
            height="100%"
            frameBorder="0"
            scrolling="no"
