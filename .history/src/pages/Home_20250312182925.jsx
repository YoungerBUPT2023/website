...
function Earth({ onMouseMove }) {
  ...
  useFrame(({ clock }) => {
    ...
    if (atmosphereRef.current) {
      atmosphereRef.current.rotation.y = elapsedTime * 0.15;
    }
  });
  ...
  return (
    <group>
      {/* 地球本体 */}
      <mesh ref={earthRef} onPointerMove={onMouseMove}>
...
function Scene() {
  return (
    <>
      ...
      <pointLight position={[100, 10, 10]} intensity={1.5} />
      <pointLight position={[-100, -10, -10]} intensity={0.5} />
