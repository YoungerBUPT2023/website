      ...
      <div className="footer" style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ marginTop: '15px' }}>
            <a href="#/privacy-policy" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px', fontSize: '0.85rem' }}>隐私政策</a>
            <a href="#/service-agreement" style={{ color: 'rgba(255, 255, 255, 0.5)', textDecoration: 'none', margin: '0 10px', fontSize: '0.85rem' }}>服务协议</a>
          </div>
        </div>
      </div>
