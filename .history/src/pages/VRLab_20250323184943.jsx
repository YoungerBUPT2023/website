...
function VRLab() {
  ...
  const [bilibiliOfficialUID, setBilibiliOfficialUID] = useState('37090048'); // 中国空间站官方账号UID，可根据需要更改
        ...
        <div className="video-player">
          ...
          {videoSource === 'bilibili' && (
            <div className="player-container">
              <div style={{ width: '100%', height: '400px', position: 'relative' }}>
                <iframe 
                  src={`//player.bilibili.com/player.html?bvid=BV1uz4y1L7F8&page=1&high_quality=1&danmaku=0&t=2.3&as_wide=1&autoplay=1&showinfo=0&noEndPanel=1&up_mid=${bilibiliOfficialUID}`}
                  scrolling="no" 
                  border="0" 
                  frameBorder="no" 
                  framespacing="0" 
