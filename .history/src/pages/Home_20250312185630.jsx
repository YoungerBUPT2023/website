...
function Home() {
  ...
  const letterSpacing = useTransform(scrollY, [0, 300], ["0.2em", "0.1em"]);
      ...
      >
        <motion.h1 
          style={{ 
            ...
            margin: 0,
            lineHeight: 1,
            opacity: useTransform(scrollY, [0, 300], [1, 0.3])
          }}
        >
          问天
        </motion.h1>
        <motion.p
          style={{ 
            opacity: useTransform(scrollY, [0, 300], [0.8, 0]),
            y: useTransform(scrollY, [0, 300], [0, -50]),
            letterSpacing: useTransform(scrollY, [0, 300], ["0.2em", "0.1em"]),
            color: '#fff',
            fontSize: '1.2rem',
            fontWeight: '300'
          }}
