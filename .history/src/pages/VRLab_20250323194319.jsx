...
function VRLab() {
  ...
  const coursesList = [
    { id: 1, title: '天宫课堂第四课——奇妙乒乓球实验', source: 'bilibili', bvid: 'BV1uz4y1L7F8' },
    { id: 2, title: '太空植物生长实验', source: 'bilibili', bvid: 'BV1YN411K7Yo' },
    { id: 3, title: '太空流体实验', source: 'bilibili', bvid: 'BV1Lm4y1s7S1' },
    { id: 4, title: '空间站生活体验', source: 'bilibili', bvid: 'BV1Ys4y1E76b' },
    { id: 5, title: '天宫课堂球形火焰实验', source: 'bilibili', bvid: 'BV1uz4y1L7F8' },
  ];
