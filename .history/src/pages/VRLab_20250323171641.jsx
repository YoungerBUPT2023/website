        ...
        <div className="video-player">
          <div className="video-header">
            ...
            <div className="video-info">
              ...
              <div className="source-switch">
                <button className="switch-button active">实验直播</button>
                <button className="switch-button">测试视频</button>
              </div>
            </div>
          </div>
          <div className="player-container">
            <ReactPlayer
              ...
              url="https://www.bilibili.com/video/BV1uz4y1L7F8/?share_source=copy_web&vd_source=878ec7a1856cbfe283783ca97141933e"
              playing={true}
              controls={true}
              width="100%"
              height="100%"
            ...
            <div className="player-controls">
              <div className="control-info">
                <span className="stream-status">⚪ 正在尝试播放...</span>
          ...
          <div className="player-container" style={{ marginTop: '20px' }}>
            <div style={{ width: '100%', height: '400px', position: 'relative' }}>
              <iframe 
                src="//player.bilibili.com/player.html?bvid=BV1uz4y1L7F8&page=1" 
                scrolling="no" 
                border="0" 
                frameBorder="no" 
                framespacing="0" 
            ...
            <div className="player-controls">
              <div className="control-info">
                <span className="stream-status">🟢 备用播放器</span>
                <span className="source-info">(如上方视频无法播放，请使用此播放器)</span>
              </div>
            </div>
          </div>
        </div>
