      ...
      <footer style={{
        ...
        <div style={{ textAlign: 'center', marginTop: '40px', borderTop: '1px solid rgba(255, 255, 255, 0.1)', paddingTop: '20px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginTop: '15px' }}>
            <a href="#" style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.85rem', textDecoration: 'none' }}>隐私政策</a>
            <a href="#" style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '0.85rem', textDecoration: 'none' }}>服务协议</a>
          </div>
        </div>
      </footer>
