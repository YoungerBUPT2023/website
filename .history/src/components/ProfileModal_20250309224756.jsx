...
import { FaCamera, FaEdit, FaTrash, FaPlus, FaHistory, FaSignOutAlt } from 'react-icons/fa';
      ...
      <div className="profile-modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="profile-actions">
          {isEditing ? (
            ...
            <button className="profile-button edit-button" onClick={handleEdit}>编辑资料</button>
          )}
        </div>
